 ...
 * @ 功能：
 */
public final class KAdapterDataObserver extends RecyclerView.AdapterDataObserver {

    private final KRecyclerAdapter mWrapAdapter;

    public KAdapterDataObserver(KRecyclerAdapter adapter) {
