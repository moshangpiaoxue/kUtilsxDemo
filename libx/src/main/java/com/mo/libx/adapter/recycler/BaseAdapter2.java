...
import com.mo.libx.base.action.ResourcesAction;
 ...
 */
public abstract class BaseAdapter2
        extends RecyclerView.Adapter<BaseAdapter2.ViewHolder> implements ResourcesAction {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(getLayoutId(viewType));
    }

    protected abstract int getLayoutId(int viewType);

    @Override
    public final void onBindViewHolder(@NonNull BaseAdapter2.ViewHolder holder, int position) {
...
//        holder.onBindView(position);
        doWhat(holder,position,getItemViewType(position));

    }

    protected abstract void doWhat(BaseAdapter2.ViewHolder vhBaseAdapter, int position, int itemViewType);
